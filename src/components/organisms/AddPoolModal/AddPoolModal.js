...
export const AddPoolModal = () => {
  ...
  const whitelistedUrl = generateLink({ amount: 1e4, data: { vote_whitelist: 1, pool_asset: pool }, aa: appConfig.AA_ADDRESS, from_address: walletAddress, is_single: !walletAddress });
